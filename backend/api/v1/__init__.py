...
from api.v1.endpoints import auth, checklist, dashboard, evaluation, governance, health, model_provider, report, runner, shannon
...
router.include_router(shannon.router, prefix="/shannon", tags=["Shannon 白盒验证"])
