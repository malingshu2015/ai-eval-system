...
import ShannonIntegration from '@/pages/shannon/ShannonIntegration'
...
import RemediationPlanDetail from '@/pages/remediation/RemediationPlanDetail'
          ...
          <BrowserRouter>
            <Routes>
              ...
              >
                ...
                <Route path="remediations/:id" element={<RemediationPlanDetail />} />
                <Route path="remediation-task/:id" element={<RemediationDetail />} />
                <Route path="pentest-hub" element={<PentestHub />} />
                <Route path="shannon" element={<ShannonIntegration />} />
